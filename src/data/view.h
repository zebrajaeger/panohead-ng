...
class View {
 public:
  View() : x1_(), x2_(), y1_(), y2_(), isPartial_(true) {}
  ...
  const Optional<double>& getX1() const { return x1_; }
  void setX1(double v) { x1_ = v; }

  const Optional<double>& getX2() const { return x2_; }
  void setX2(double v) { x2_ = v; }

  const Optional<double>& getY1() const { return y1_; }
  void setY1(double v) { y1_ = v; }

  const Optional<double>& getY2() const { return y2_; }
